...
class C_Kapasitas extends CI_Controller {
    ...
    public function index() {
		...
		if(!$data['kapasitas']) {
			if(!$id_faskes) {
				...
				redirect('pegawai/c_kapasitas/tambah_kapasitas/'.$id_faskes);
			}
		} else {
			$this->load->view('templates/header', $data);
			$this->load->view('templates/sidebar', $data);
			$this->load->view('templates/topbar');
			$this->load->view('pegawai/kapasitas/v_kapasitas', $data);
    ...
    public function update_kapasitas($id_faskes) {
        ...
        if ($this->form_validation->run() == false) {
            redirect('pegawai/c_kapasitas/detail_kapasitas/'.$id_faskes);
        } else {
    ...
    public function tambah_kapasitas($id_faskes) {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar');
            $this->load->view('pegawai/kapasitas/v_tambahkapasitas', $data);
            $this->load->view('templates/content_footer');
            $this->load->view('templates/footer');
        } else {
